 ...
 */
 ...
 //TODO faire des affichages + beau, extraire code (faire + petit)
final class Main {
	...
	//Variable qui contient le chemin vers le fichier contenant les requêtes
	static String queryFile; //todo remettre comme avant
